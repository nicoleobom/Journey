        ...
        return(
            <div className="row" id="q3">
                <form className="col-sm-12 header bg-q">
                    ...
                    <span className="d-s">$</span><input id="budgetinput" type="number" min="100" step="100" onChange={this.props.handleChange('budget')} defaultValue={values.budget} placeholder="Search..."></input>
                </form>
