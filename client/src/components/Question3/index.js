    ...
    render() {
        ...
        return (
            <div className="row home-pg-2" id="q3">
                <form className="col-sm-12 q-header bg-q" onSubmit={this.checkBudget}>
                    ...
                    <div className="col-sm-12">
                        <div className="row">
                            ...
                            <div className="col" style={{ paddingTop: "15px" }}>
                                <button type="submit" className="next" style={{ display: "block", margin: "auto" }} onClick={this.nextQuestion}><i className="fas fa-angle-right fa-2x"></i></button>
                            </div>
                        </div>
                    </div>
                    </form>
